...
public class MazeGame {
     ...
     * @return Method to create crateMaze; it is creating maze with rooms in it and rooms are creating doors in it.
     ...
     * @param layout   : it tells the type of layout selected by the user like Layout1 or layout 2.
     * @return This is a helper method to get the class obejct for different doors we have.
