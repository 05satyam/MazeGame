...
public interface MazeDoorInterface extends MapSiteBaseInterfaceClass {
     ...
     * @return this method will return the object of the door to door interface  based on door type selected by user
     */
    static MazeDoorInterface getDoorInterfaceFromDoorChoice(String doorTypeName) {
        switch (doorTypeName) {
            case "BombDoor":
                return BombDoor.getBombDoorFactorySingletonInstance();
            case "EnchantedDoor":
                return EnchantedDoor.getEnchantedDoorFactorySingletonInstance();
            case "GlassDoor":
                return GlassDoor.getGlassDoorFactorySingletonInstance();
            default:
                break;
        }
        return null;
